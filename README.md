...
int main(void)
{
  ...
  Lcd_cursor(&lcd,0,1);
  Lcd_string(&lcd,"B KRISHNAKANTH");
  Lcd_cursor(&lcd,1,0);
         Lcd_string(&lcd, "212223230109");
         HAL_Delay(500);
  while (1)
  {
...
![WhatsApp Image 2024-09-25 at 10 12 59_04ba4d77](https://github.com/user-attachments/assets/8221a78d-ca1b-4f3a-aa48-61b4208395a7)
